...
The backend for [FlightPulse](https://flightpulse-frontend.vercel.app): a FastAPI service that serves flight, airline, airport and aircraft data from Databricks, plus live airport weather and flight routes.
...
- **Databricks** holds the data, loaded by two scheduled jobs: aircraft positions from OpenSky every 30 minutes, and flights from Aviationstack once a day.
...
You need Python 3.9+ and access to the Databricks SQL warehouse.
